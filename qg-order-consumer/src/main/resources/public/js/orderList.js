        ...
        success: function (result) {
            ...
            if (result.code == 0) {
                ...
                for (var i = 0; i < list.length; i++) {
                    ...
                    var $goodsImgDiv = $("<div class=\"shangPin\" ><img th:src=\"@{/img/daisen.png}\"/></div>");
...
function toPay(orderid) {
    window.location.href=ReqUrl.OrdeReqUrl() + "orderDetail.html?orderId="+orderid + "&token=" + getCookie("token");
}